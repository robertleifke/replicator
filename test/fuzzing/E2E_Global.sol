...
//         address enginequote = engine.quote();
//         address enginebase = engine.base();

//         assert(enginebase == address(base));
//         assert(enginequote == address(quote));
//     }
...
//         (uint128 balancequote, uint128 balancebase) = engine.margins(address(0));
//         assert(balancequote == 0);
//         assert(balancebase == 0);
//     }
